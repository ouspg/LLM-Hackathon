...
- Download & run a desired LLM with ollama *(replace `phi3` with the corresponding LLM tag; visit [Ollama Library](https://ollama.com/library) for available models)*: `docker exec -it ollama ollama run phi3`
